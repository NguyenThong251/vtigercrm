<?php
/*+***********************************************************************************
 * Demo5 — Custom module generated by FcvModuleBuilder
 ************************************************************************************/
class Demo5 extends CRMEntity {
    ...
    var $table_name  = 'vtiger_demo5';
    var $table_index = 'demo5id';
    ...
    var $tab_name_index = [
        ...
        'vtiger_demo5'   => 'demo5id',
        'vtiger_demo5cf' => 'demo5id',
    ];

    var $entity_table = 'vtiger_crmentity';

    /** Required for custom fields support */
    var $customFieldTable = ['vtiger_demo5cf', 'demo5id'];

    var $column_fields = [];

    var $additional_column_fields = ['smcreatorid', 'smownerid', 'crmid'];

    var $mandatory_fields = ['assigned_user_id', 'demo5name', 'createdtime', 'modifiedtime'];

    var $sortby_fields = [];

    var $list_fields = [
        'Name'        => ['demo5' => 'demo5name'],
    ...
    var $def_basicsearch_col = 'demo5name';

    var $default_order_by   = 'demo5name';
    var $default_sort_order = 'ASC';

    var $module_name = 'Demo5';
