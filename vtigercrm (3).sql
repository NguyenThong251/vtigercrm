...
--
-- Máy chủ: mysql8:3306
-- Thời gian đã tạo: Th5 10, 2026 lúc 06:17 AM
...
CREATE TABLE `vtiger_calendarsharedtype` (
  `calendarsharedtypeid` int NOT NULL,
...
CREATE TABLE `vtiger_contract_priority` (
  `contract_priorityid` int NOT NULL,
...
CREATE TABLE `vtiger_contract_status` (
  `contract_statusid` int NOT NULL,
...
CREATE TABLE `vtiger_currency_decimal_separator` (
  `currency_decimal_separatorid` int NOT NULL,
...
CREATE TABLE `vtiger_currency_grouping_pattern` (
  `currency_grouping_patternid` int NOT NULL,
...
CREATE TABLE `vtiger_currency_grouping_separator` (
  `currency_grouping_separatorid` int NOT NULL,
...
CREATE TABLE `vtiger_currency_symbol_placement` (
  `currency_symbol_placementid` int NOT NULL,
...
(14, '{\"assigned_user_id\":1,\"productname\":1}', 1),
...
(23, '{\"bill_street\":1,\"ship_street\":1,\"subject\":1,\"account_id\":1,\"assigned_user_id\":1}', 1),
(35, '{\"subject\":1,\"assigned_user_id\":1}', NULL),
(36, '{\"servicename\":1}', 1),
(38, '{\"product\":1,\"assigned_user_id\":1,\"serialnumber\":1,\"datesold\":1,\"dateinservice\":1,\"assetstatus\":1,\"assetname\":1,\"account\":1}', 1),
...
CREATE TABLE `vtiger_defaultactivitytype` (
  `defaultactivitytypeid` int NOT NULL,
...
CREATE TABLE `vtiger_defaultcalendarview` (
  `defaultcalendarviewid` int NOT NULL,
...
CREATE TABLE `vtiger_defaulteventstatus` (
  `defaulteventstatusid` int NOT NULL,
...
CREATE TABLE `vtiger_defaultlandingpage` (
  `defaultlandingpageid` int NOT NULL,
...
CREATE TABLE `vtiger_default_record_view` (
  `default_record_viewid` int NOT NULL,
...
CREATE TABLE `vtiger_eventhandler_module` (
  `eventhandler_module_id` int NOT NULL,
  `module_name` varchar(100) DEFAULT NULL,
...
CREATE TABLE `vtiger_expectedresponse` (
  `expectedresponseid` int NOT NULL,
...
(1, 'English', 'en_us', 'US English', '2026-05-10 06:10:15', NULL, 1, 1),
(2, 'Arabic', 'ar_ae', 'Arabic', '2026-05-10 06:12:52', NULL, 0, 1),
(3, 'Brazilian', 'pt_br', 'PT Brasil', '2026-05-10 06:12:12', NULL, 0, 1),
(4, 'British English', 'en_gb', 'British English', '2026-05-10 06:11:53', NULL, 0, 1),
(5, 'Deutsch', 'de_de', 'DE Deutsch', '2026-05-10 06:11:54', NULL, 0, 1),
(6, 'Dutch', 'nl_nl', 'NL-Dutch', '2026-05-10 06:11:54', NULL, 0, 1),
(7, 'Pack de langue français', 'fr_fr', 'Pack de langue français', '2026-05-10 06:12:13', NULL, 0, 1),
(8, 'Hungarian', 'hu_hu', 'HU Magyar', '2026-05-10 06:11:54', NULL, 0, 1),
(9, 'Italian', 'it_it', 'IT Italian', '2026-05-10 06:11:54', NULL, 0, 1),
(10, 'Mexican Spanish', 'es_mx', 'ES Mexico', '2026-05-10 06:11:54', NULL, 0, 1),
(11, 'Język Polski', 'pl_pl', 'Język Polski', '2026-05-10 06:12:13', NULL, 0, 1),
(12, 'Romana', 'ro_ro', 'Romana', '2026-05-10 06:12:13', NULL, 0, 1),
(13, 'Russian', 'ru_ru', 'Russian', '2026-05-10 06:12:09', NULL, 0, 1),
(14, 'Spanish', 'es_es', 'ES Spanish', '2026-05-10 06:12:11', NULL, 0, 1),
(15, 'Swedish', 'sv_se', 'Swedish', '2026-05-10 06:12:52', NULL, 0, 1),
(16, 'Turkce', 'tr_tr', 'Turkce Dil Paketi', '2026-05-10 06:12:11', NULL, 0, 1);
...
(1, 'admin', '::1', '2026-05-10 05:14:03', '2026-05-10 05:14:03', 'Signed in');
...
CREATE TABLE `vtiger_notificationscheduler` (
  `schedulednotificationid` int NOT NULL,
...
CREATE TABLE `vtiger_no_of_currency_decimals` (
  `no_of_currency_decimalsid` int NOT NULL,
...
CREATE TABLE `vtiger_othereventduration` (
  `othereventdurationid` int NOT NULL,
...
CREATE TABLE `vtiger_projectmilestonetype` (
  `projectmilestonetypeid` int NOT NULL,
...
CREATE TABLE `vtiger_projecttaskprogress` (
  `projecttaskprogressid` int NOT NULL,
...
CREATE TABLE `vtiger_reminder_interval` (
  `reminder_intervalid` int NOT NULL,
...
CREATE TABLE `vtiger_service_usageunit` (
  `service_usageunitid` int NOT NULL,
...
CREATE TABLE `vtiger_ticketcategories` (
  `ticketcategories_id` int NOT NULL,
...
CREATE TABLE `vtiger_ticketpriorities` (
  `ticketpriorities_id` int NOT NULL,
...
CREATE TABLE `vtiger_ticketseverities` (
  `ticketseverities_id` int NOT NULL,
...
(1, 'admin', '$2y$10$lpFq6VsOEoZ7gP5ig3dkQ.lF/BTmUfSlPIGKHgVC8vGan4qUlNJqK', '#E6FAD8', 'admin', 'Administrator', '', 'on', 1, '', '0000-00-00 00:00:00', NULL, NULL, '', '', '', '', '', '', '', 'ht01252004@gmail.com', '', '', 'Active', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 'mm-dd-yyyy', '12', '00:00', '23:00', '1', 'This Week', 'Today', '', 0, '$2y$10$vmIlC7HlfJ/qaCy1vPB/cuLSqwfb/3vlttej7IOLhjLfGKXaDDS12', '1', '1 Minute', NULL, 'PHASH', 'xpMm2O2Tsijl5Nx', 'alphagrey', 'en_us', 'America/Los_Angeles', '123,456,789', '.', ',', '$1.0', 'admin Administrator', 'Home', '', '2', '1', 'Sunday', '5', '5', 'public', 'Summary', '0', '', 'Planned', 'Call', 0, 'MyCalendar');
...
(1, 'vtigerCRM', '6a00139558c77', 'user');
...
(2, 'Invoice', 'include/Webservices/LineItem/VtigerInventoryOperation.php', 'VtigerInventoryOperation', 1),
(3, 'SalesOrder', 'include/Webservices/LineItem/VtigerInventoryOperation.php', 'VtigerInventoryOperation', 1),
(4, 'PurchaseOrder', 'include/Webservices/LineItem/VtigerInventoryOperation.php', 'VtigerInventoryOperation', 1),
(5, 'Quotes', 'include/Webservices/LineItem/VtigerInventoryOperation.php', 'VtigerInventoryOperation', 1),
(6, 'Faq', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1),
(7, 'Vendors', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1),
...
--
ALTER TABLE `com_vtiger_workflows`
  MODIFY `workflow_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT cho bảng `com_vtiger_workflowtasks`
--
ALTER TABLE `com_vtiger_workflowtasks`
  MODIFY `task_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `vtiger_accountrating`
  MODIFY `accountratingid` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `vtiger_accounttype`
--
ALTER TABLE `vtiger_accounttype`
  MODIFY `accounttypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `vtiger_activitytype`
--
ALTER TABLE `vtiger_activitytype`
  MODIFY `activitytypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `vtiger_activity_view`
  MODIFY `activity_viewid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `vtiger_assetstatus`
--
ALTER TABLE `vtiger_assetstatus`
  MODIFY `assetstatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `vtiger_attachmentsfolder`
--
ALTER TABLE `vtiger_attachmentsfolder`
  MODIFY `folderid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `vtiger_calendarsharedtype`
--
ALTER TABLE `vtiger_calendarsharedtype`
  MODIFY `calendarsharedtypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `vtiger_callduration`
--
ALTER TABLE `vtiger_callduration`
  MODIFY `calldurationid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `vtiger_campaignstatus`
--
ALTER TABLE `vtiger_campaignstatus`
  MODIFY `campaignstatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `vtiger_campaigntype`
--
ALTER TABLE `vtiger_campaigntype`
  MODIFY `campaigntypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT cho bảng `vtiger_carrier`
--
ALTER TABLE `vtiger_carrier`
  MODIFY `carrierid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `vtiger_contract_priority`
--
ALTER TABLE `vtiger_contract_priority`
  MODIFY `contract_priorityid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `vtiger_contract_status`
--
ALTER TABLE `vtiger_contract_status`
  MODIFY `contract_statusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `vtiger_contract_type`
--
ALTER TABLE `vtiger_contract_type`
  MODIFY `contract_typeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `vtiger_convertleadmapping`
--
ALTER TABLE `vtiger_convertleadmapping`
  MODIFY `cfmid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT cho bảng `vtiger_convertpotentialmapping`
--
ALTER TABLE `vtiger_convertpotentialmapping`
  MODIFY `cfmid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `vtiger_currencies`
  MODIFY `currencyid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
...
--
ALTER TABLE `vtiger_currency_decimal_separator`
  MODIFY `currency_decimal_separatorid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `vtiger_currency_grouping_pattern`
--
ALTER TABLE `vtiger_currency_grouping_pattern`
  MODIFY `currency_grouping_patternid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_currency_grouping_separator`
--
ALTER TABLE `vtiger_currency_grouping_separator`
  MODIFY `currency_grouping_separatorid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `vtiger_currency_symbol_placement`
  MODIFY `currency_symbol_placementid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `vtiger_date_format`
  MODIFY `date_formatid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `vtiger_dayoftheweek`
--
ALTER TABLE `vtiger_dayoftheweek`
  MODIFY `dayoftheweekid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `vtiger_defaultactivitytype`
--
ALTER TABLE `vtiger_defaultactivitytype`
  MODIFY `defaultactivitytypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `vtiger_defaultcalendarview`
--
ALTER TABLE `vtiger_defaultcalendarview`
  MODIFY `defaultcalendarviewid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `vtiger_defaulteventstatus`
--
ALTER TABLE `vtiger_defaulteventstatus`
  MODIFY `defaulteventstatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `vtiger_defaultlandingpage`
--
ALTER TABLE `vtiger_defaultlandingpage`
  MODIFY `defaultlandingpageid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `vtiger_default_record_view`
--
ALTER TABLE `vtiger_default_record_view`
  MODIFY `default_record_viewid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `vtiger_def_org_share`
--
ALTER TABLE `vtiger_def_org_share`
  MODIFY `ruleid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT cho bảng `vtiger_durationhrs`
--
ALTER TABLE `vtiger_durationhrs`
  MODIFY `hrsid` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `vtiger_durationmins`
--
ALTER TABLE `vtiger_durationmins`
  MODIFY `minsid` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `vtiger_duration_minutes`
--
ALTER TABLE `vtiger_duration_minutes`
  MODIFY `minutesid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `vtiger_emailtemplates`
  MODIFY `templateid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT cho bảng `vtiger_eventhandlers`
--
ALTER TABLE `vtiger_eventhandlers`
  MODIFY `eventhandler_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT cho bảng `vtiger_eventhandler_module`
--
ALTER TABLE `vtiger_eventhandler_module`
  MODIFY `eventhandler_module_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_eventstatus`
--
ALTER TABLE `vtiger_eventstatus`
  MODIFY `eventstatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `vtiger_expectedresponse`
--
ALTER TABLE `vtiger_expectedresponse`
  MODIFY `expectedresponseid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `vtiger_faqcategories`
  MODIFY `faqcategories_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `vtiger_faqstatus`
  MODIFY `faqstatus_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_field`
--
ALTER TABLE `vtiger_field`
  MODIFY `fieldid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=853;

--
-- AUTO_INCREMENT cho bảng `vtiger_glacct`
--
ALTER TABLE `vtiger_glacct`
  MODIFY `glacctid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT cho bảng `vtiger_hour_format`
--
ALTER TABLE `vtiger_hour_format`
  MODIFY `hour_formatid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `vtiger_industry`
  MODIFY `industryid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT cho bảng `vtiger_inventorycharges`
--
ALTER TABLE `vtiger_inventorycharges`
  MODIFY `chargeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `vtiger_invoicestatus`
  MODIFY `invoicestatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `vtiger_leadsource`
  MODIFY `leadsourceid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT cho bảng `vtiger_leadstage`
--
ALTER TABLE `vtiger_leadstage`
  MODIFY `leadstageid` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `vtiger_leadstatus`
--
ALTER TABLE `vtiger_leadstatus`
  MODIFY `leadstatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `vtiger_lead_view`
--
ALTER TABLE `vtiger_lead_view`
  MODIFY `lead_viewid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `vtiger_mailscanner`
  MODIFY `scannerid` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `vtiger_mailscanner_rules`
  MODIFY `ruleid` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `vtiger_manufacturer`
--
ALTER TABLE `vtiger_manufacturer`
  MODIFY `manufacturerid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `vtiger_notificationscheduler`
  MODIFY `schedulednotificationid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `vtiger_no_of_currency_decimals`
--
ALTER TABLE `vtiger_no_of_currency_decimals`
  MODIFY `no_of_currency_decimalsid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `vtiger_opportunitystage`
--
ALTER TABLE `vtiger_opportunitystage`
  MODIFY `potstageid` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `vtiger_opportunity_type`
--
ALTER TABLE `vtiger_opportunity_type`
  MODIFY `opptypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `vtiger_othereventduration`
--
ALTER TABLE `vtiger_othereventduration`
  MODIFY `othereventdurationid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `vtiger_pbxmanager`
--
ALTER TABLE `vtiger_pbxmanager`
  MODIFY `pbxmanagerid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `vtiger_picklist`
  MODIFY `picklistid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT cho bảng `vtiger_postatus`
--
ALTER TABLE `vtiger_postatus`
  MODIFY `postatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `vtiger_productcategory`
  MODIFY `productcategoryid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_profile`
--
ALTER TABLE `vtiger_profile`
  MODIFY `profileid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_progress`
--
ALTER TABLE `vtiger_progress`
  MODIFY `progressid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `vtiger_projectmilestonetype`
--
ALTER TABLE `vtiger_projectmilestonetype`
  MODIFY `projectmilestonetypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_projectpriority`
--
ALTER TABLE `vtiger_projectpriority`
  MODIFY `projectpriorityid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_projectstatus`
--
ALTER TABLE `vtiger_projectstatus`
  MODIFY `projectstatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT cho bảng `vtiger_projecttaskpriority`
--
ALTER TABLE `vtiger_projecttaskpriority`
  MODIFY `projecttaskpriorityid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_projecttaskprogress`
--
ALTER TABLE `vtiger_projecttaskprogress`
  MODIFY `projecttaskprogressid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `vtiger_projecttaskstatus`
--
ALTER TABLE `vtiger_projecttaskstatus`
  MODIFY `projecttaskstatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `vtiger_projecttasktype`
--
ALTER TABLE `vtiger_projecttasktype`
  MODIFY `projecttasktypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_projecttype`
--
ALTER TABLE `vtiger_projecttype`
  MODIFY `projecttypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_quotestage`
--
ALTER TABLE `vtiger_quotestage`
  MODIFY `quotestageid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `vtiger_recurringevents`
  MODIFY `recurringid` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `vtiger_recurringtype`
--
ALTER TABLE `vtiger_recurringtype`
  MODIFY `recurringeventid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `vtiger_reminder_interval`
--
ALTER TABLE `vtiger_reminder_interval`
  MODIFY `reminder_intervalid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `vtiger_reportfolder`
--
ALTER TABLE `vtiger_reportfolder`
  MODIFY `folderid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `vtiger_rollupcomments_settings`
--
ALTER TABLE `vtiger_rollupcomments_settings`
  MODIFY `rollupid` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `vtiger_rowheight`
--
ALTER TABLE `vtiger_rowheight`
  MODIFY `rowheightid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `vtiger_sales_stage`
--
ALTER TABLE `vtiger_sales_stage`
  MODIFY `sales_stage_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT cho bảng `vtiger_salutationtype`
--
ALTER TABLE `vtiger_salutationtype`
  MODIFY `salutationid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `vtiger_service_usageunit`
  MODIFY `service_usageunitid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `vtiger_sostatus`
  MODIFY `sostatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `vtiger_start_hour`
  MODIFY `start_hourid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `vtiger_taskpriority`
  MODIFY `taskpriorityid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `vtiger_taskstatus`
--
ALTER TABLE `vtiger_taskstatus`
  MODIFY `taskstatusid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `vtiger_taxclass`
--
ALTER TABLE `vtiger_taxclass`
  MODIFY `taxclassid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `vtiger_ticketcategories`
  MODIFY `ticketcategories_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `vtiger_ticketpriorities`
  MODIFY `ticketpriorities_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_ticketseverities`
--
ALTER TABLE `vtiger_ticketseverities`
  MODIFY `ticketseverities_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_ticketstatus`
--
ALTER TABLE `vtiger_ticketstatus`
  MODIFY `ticketstatus_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_time_zone`
--
ALTER TABLE `vtiger_time_zone`
  MODIFY `time_zoneid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
...
--
ALTER TABLE `vtiger_tracking_unit`
  MODIFY `tracking_unitid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `vtiger_usageunit`
--
ALTER TABLE `vtiger_usageunit`
  MODIFY `usageunitid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `vtiger_visibility`
  MODIFY `visibilityid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `vtiger_ws_entity_fieldtype`
  MODIFY `fieldtypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT cho bảng `vtiger_ws_fieldtype`
--
ALTER TABLE `vtiger_ws_fieldtype`
  MODIFY `fieldtypeid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT cho bảng `vtiger_ws_operation`
--
ALTER TABLE `vtiger_ws_operation`
  MODIFY `operationid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
-- Ràng buộc cho bảng `vtiger_activityproductrel`
--
ALTER TABLE `vtiger_activityproductrel`
...
--
-- Ràng buộc cho bảng `vtiger_activity_reminder`
--
ALTER TABLE `vtiger_activity_reminder`
...
--
-- Ràng buộc cho bảng `vtiger_contactaddress`
--
ALTER TABLE `vtiger_contactaddress`
...
--
-- Ràng buộc cho bảng `vtiger_contpotentialrel`
--
ALTER TABLE `vtiger_contpotentialrel`
...
--
-- Ràng buộc cho bảng `vtiger_crmentity_user_field`
--
ALTER TABLE `vtiger_crmentity_user_field`
...
--
-- Ràng buộc cho bảng `vtiger_cv2role`
--
ALTER TABLE `vtiger_cv2role`
...
--
-- Ràng buộc cho bảng `vtiger_cv2rs`
--
ALTER TABLE `vtiger_cv2rs`
...
--
-- Ràng buộc cho bảng `vtiger_cv2users`
--
ALTER TABLE `vtiger_cv2users`
...
--
-- Ràng buộc cho bảng `vtiger_invoicebillads`
--
ALTER TABLE `vtiger_invoicebillads`
...
--
-- Ràng buộc cho bảng `vtiger_invoicestatushistory`
--
ALTER TABLE `vtiger_invoicestatushistory`
...
--
-- Ràng buộc cho bảng `vtiger_invoice_recurring_info`
--
ALTER TABLE `vtiger_invoice_recurring_info`
...
--
-- Ràng buộc cho bảng `vtiger_module_dashboard_widgets`
--
ALTER TABLE `vtiger_module_dashboard_widgets`
...
--
-- Ràng buộc cho bảng `vtiger_pbxmanager_phonelookup`
--
ALTER TABLE `vtiger_pbxmanager_phonelookup`
...
--
-- Ràng buộc cho bảng `vtiger_pobillads`
--
ALTER TABLE `vtiger_pobillads`
...
--
-- Ràng buộc cho bảng `vtiger_postatushistory`
--
ALTER TABLE `vtiger_postatushistory`
...
--
-- Ràng buộc cho bảng `vtiger_potstagehistory`
--
ALTER TABLE `vtiger_potstagehistory`
...
--
-- Ràng buộc cho bảng `vtiger_projectmilestonecf`
--
ALTER TABLE `vtiger_projectmilestonecf`
...
--
-- Ràng buộc cho bảng `vtiger_purchaseorder`
--
ALTER TABLE `vtiger_purchaseorder`
...
--
-- Ràng buộc cho bảng `vtiger_purchaseordercf`
--
ALTER TABLE `vtiger_purchaseordercf`
...
--
-- Ràng buộc cho bảng `vtiger_quotes`
--
ALTER TABLE `vtiger_quotes`
...
--
-- Ràng buộc cho bảng `vtiger_quotesbillads`
--
ALTER TABLE `vtiger_quotesbillads`
...
--
-- Ràng buộc cho bảng `vtiger_report_sharerole`
--
ALTER TABLE `vtiger_report_sharerole`
...
--
-- Ràng buộc cho bảng `vtiger_report_sharers`
--
ALTER TABLE `vtiger_report_sharers`
...
--
-- Ràng buộc cho bảng `vtiger_report_shareusers`
--
ALTER TABLE `vtiger_report_shareusers`
...
--
-- Ràng buộc cho bảng `vtiger_role2picklist`
--
ALTER TABLE `vtiger_role2picklist`
...
--
-- Ràng buộc cho bảng `vtiger_salesordercf`
--
ALTER TABLE `vtiger_salesordercf`
...
--
-- Ràng buộc cho bảng `vtiger_servicecontractscf`
--
ALTER TABLE `vtiger_servicecontractscf`
...
--
-- Ràng buộc cho bảng `vtiger_sobillads`
--
ALTER TABLE `vtiger_sobillads`
...
--
-- Ràng buộc cho bảng `vtiger_soshipads`
--
ALTER TABLE `vtiger_soshipads`
...
--
-- Ràng buộc cho bảng `vtiger_sostatushistory`
--
ALTER TABLE `vtiger_sostatushistory`
...
--
-- Ràng buộc cho bảng `vtiger_tmp_read_group_rel_sharing_per`
--
ALTER TABLE `vtiger_tmp_read_group_rel_sharing_per`
...
--
-- Ràng buộc cho bảng `vtiger_ws_entity_tables`
--
ALTER TABLE `vtiger_ws_entity_tables`
...
--
-- Ràng buộc cho bảng `vtiger_ws_referencetype`
--
ALTER TABLE `vtiger_ws_referencetype`
